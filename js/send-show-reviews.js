...
import { getFirestore, collection,  getDocs, addDoc, updateDoc, doc, deleteDoc} from "https://www.gstatic.com/firebasejs/9.0.0/firebase-firestore.js";
...
const firebaseConfig = {
  ...
  async function loadReviews() {
      ...
      reviewsSnapshot.forEach((doc) => {
          ...
          review.id = doc.id; // Add Firestore document ID
  ...
  async function updateReview(updatedReview) {
      try {
          const reviewRef = doc(db, 'reviews', updatedReview.id);
